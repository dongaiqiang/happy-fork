...
export class ApiMachineClient {
    ...
    setRPCHandlers({
        ...
        this.rpcHandlerManager.registerHandler('spawn-happy-session', async (params: any) => {
            const { directory, sessionId, happySessionId, machineId, openTerminal, terminalCarrierMode, approvedNewDirectoryCreation, agent, token, environmentVariables } = params || {};
            ...
            const result = await spawnSession({ directory, sessionId, happySessionId, machineId, openTerminal, terminalCarrierMode, approvedNewDirectoryCreation, agent, token, environmentVariables });
