...
export const zhHant: TranslationStructure = {
    ...
    newSession: {
        ...
        emptySessionsDescriptionWithMachines: '可以在任何已連線的裝置上啟動新的工作階段。',
        emptySessionsDescriptionWithoutMachines: '請先在你的電腦上開啟新的終端機來啟動工作階段。',
        promptPlaceholder: '你想處理什麼工作？',
        machinePicker: {
            title: '選擇裝置',
            searchPlaceholder: '輸入以篩選裝置...',
            recentSectionTitle: '最近使用的裝置',
            favoritesSectionTitle: '收藏裝置',
            allSectionTitle: '全部裝置',
            noItemsMessage: '暫無可用裝置',
            removeFavoriteTitle: '移除收藏',
            removeFavoriteMessage: ({ machine }: { machine: string }) => `要將「${machine}」從收藏裝置中移除嗎？`,
        },
        pathPicker: {
            title: '選擇路徑',
            noMachineSelected: '尚未選擇裝置',
        ...
        profileSection: {
            ...
            dismissThisMachine: '此裝置',
            dismissAnyMachine: '任何裝置',
    ...
    sessionInfo: {
        ...
        resumeNoAvailableMachine: ({ machineId }: { machineId: string }) =>
            `目前沒有可用於恢復的在線裝置。這個歷史工作階段綁定的裝置 ID 是 ${machineId}，但應用程式沒有找到對應的加密資訊。通常表示舊裝置記錄已失效，請重新整理裝置列表或重新登入後再試。`,
        createDirectoryTitle: '建立目錄？',
        createDirectoryMessage: ({ directory }: { directory: string }) =>
            `目錄「${directory}」不存在。要現在建立嗎？`,
        resumeRpcUnavailable: '守護程序雖然正在執行，但目前沒有連上後端 WebSocket，因此服務端無法透過 RPC 存取這台裝置。請重新啟動 happy-server 和守護程序後再試。',
        resumeMachineOffline: '裝置目前離線。請先在這台裝置上啟動守護程序後再試。',
        openOnMacTitle: '在 Mac 上開啟',
        openOnMacConfirm: '在 Mac 上開啟',
        openOnMacDescription: '要在 Mac 上開啟這個工作階段嗎？開啟後，Mac 會成為預設控制端，手機會保持唯讀，直到您切換回來。',
        ...
        openOnMacOpeningSubtitle: '正在 Mac 上開啟工作階段...',
        openOnMacReadySubtitle: '在 Mac 上開啟同一個工作階段，手機保持目前控制狀態',
        openOnMacSetupSubtitle: '嘗試先在您的 Mac 上為這個工作階段建立由 tmux 託管的 Claude 終端',
        openOnMacMissingMetadata: '此工作階段缺少必要中繼資料，無法切換到 Mac。',
        openOnMacNoAvailableMachine: ({ machineId }: { machineId: string }) =>
            `目前沒有可用於「在 Mac 上開啟」的在線裝置。這個歷史工作階段綁定的裝置 ID 是 ${machineId}，但應用程式沒有找到對應的加密資訊。通常表示舊裝置記錄已失效，請重新整理裝置列表或重新登入後再試。`,
        ...
        openOnMacAuthHint: '提示：守護程序使用的 Claude 登入狀態 / 設定可能與目前終端不同。請用相同登入環境重新啟動守護程序後再試。',
        openOnMacRouteMissing: ({ claudeSessionId, directory }: { claudeSessionId: string; directory: string }) =>
            `在 Mac 上開啟失敗\n原因：目前服務尚未部署「在 Mac 上開啟」所需介面。請重新部署 happy-server 後再試。\nclaudeSessionId: ${claudeSessionId}\ndirectory: ${directory}`,
        ...
        updateCliInstructions: '更新命令：npm install -g happy-coder@latest',
        enabled: '已啟用',
        disabled: '已停用',
    ...
    restore: {
        ...
        restoreWithSecretKeyInstead: '改用金鑰恢復',
        enterSecretKeyInstructions: '輸入您的金鑰以恢復帳戶存取。',
    ...
    welcome: {
        ...
        createAccount: '在此裝置建立帳戶',
        linkOrRestoreAccount: '匯入或恢復既有帳戶',
        loginWithMobileApp: '連結既有 HelloVibe 帳戶',
        createAccountFailedInvalidResponse: '建立帳戶失敗：伺服器沒有回傳有效的登入資訊。請先確認右上角的伺服器位址已改成 https://api.hellovibe.com，然後再試一次。',
        createAccountFailedWithReason: ({ reason }: { reason: string }) =>
            `建立帳戶失敗：${reason}。請先確認右上角的伺服器位址已改成 https://api.hellovibe.com，然後再試一次。`,
    },
    ...
    machine: {
        ...
        offlineHelp: '• 確保您的電腦在線上\n• 執行 `happy daemon status` 進行診斷\n• 如有需要，請使用 `npm install -g happy-coder@latest` 更新 CLI',
        daemon: '守護程序',
        status: '狀態',
        ...
        stopDaemonConfirmMessage: '停止後，在您重新於電腦上啟動守護程序之前，將無法在這台裝置上啟動新工作階段。當前工作階段仍會保留。',
        daemonStopped: '守護程序已停止',
        stopDaemonFailed: '停止守護程序失敗，可能目前並未執行。',
        ...
        machineNotFound: '找不到裝置',
        unknownMachine: '未知裝置',
        multipleMachines: ({ count }: { count: number }) => `${count} 台裝置`,
        renameMachineTitle: '重新命名裝置',
        renameMachineMessage: '為這台裝置設定自訂名稱。留空則繼續使用預設主機名稱。',
        renameMachinePlaceholder: '輸入裝置名稱',
        renameMachineSuccess: '裝置名稱修改成功',
        renameMachineFailed: '修改裝置名稱失敗',
        createDirectoryTitle: '建立目錄？',
        createDirectoryMessage: ({ directory }: { directory: string }) =>
            `目錄「${directory}」不存在。要現在建立它嗎？`,
        startSessionFailed: '啟動工作階段失敗。請確認目標裝置上的守護程序已經執行。',
        unknownPath: '未知路徑',
