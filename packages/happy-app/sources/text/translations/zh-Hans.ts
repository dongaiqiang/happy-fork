...
export const zhHans: TranslationStructure = {
    ...
    newSession: {
        ...
        emptySessionsDescriptionWithMachines: '可以在任意已连接设备上启动一个新会话。',
        emptySessionsDescriptionWithoutMachines: '请先在电脑上打开一个新终端来启动会话。',
        promptPlaceholder: '你想处理什么工作？',
        machinePicker: {
            title: '选择设备',
            searchPlaceholder: '输入以筛选设备...',
            recentSectionTitle: '最近使用的设备',
            favoritesSectionTitle: '收藏设备',
            allSectionTitle: '全部设备',
            noItemsMessage: '暂无可用设备',
            removeFavoriteTitle: '移除收藏',
            removeFavoriteMessage: ({ machine }: { machine: string }) => `要将“${machine}”从收藏设备中移除吗？`,
        },
        pathPicker: {
            title: '选择路径',
            noMachineSelected: '尚未选择设备',
        ...
        profileSection: {
            ...
            dismissThisMachine: '此设备',
            dismissAnyMachine: '任意设备',
    ...
    sessionInfo: {
        ...
        resumeNoAvailableMachine: ({ machineId }: { machineId: string }) =>
            `当前没有可用于恢复的在线设备。这个历史会话绑定的设备 ID 是 ${machineId}，但应用没有找到对应的加密信息。通常表示旧设备记录已失效，请刷新设备列表或重新登录后再试。`,
        ...
        openOnMacDescription: '要在 Mac 上打开这个会话吗？打开后，Mac 会成为默认控制端，手机会保持只读，直到您切换回来。',
        ...
        openOnMacOpeningSubtitle: '正在 Mac 上打开会话...',
        openOnMacReadySubtitle: '在 Mac 上打开同一个会话，手机保持当前控制状态',
        openOnMacSetupSubtitle: '尝试先在您的 Mac 上为这个会话创建一个由 tmux 托管的 Claude 终端',
        openOnMacMissingMetadata: '此会话缺少必要元数据，无法切换到 Mac。',
        openOnMacNoAvailableMachine: ({ machineId }: { machineId: string }) =>
            `当前没有可用于“在 Mac 上打开”的在线设备。这个历史会话绑定的设备 ID 是 ${machineId}，但应用没有找到对应的加密信息。通常表示旧设备记录已失效，请刷新设备列表或重新登录后再试。`,
    ...
    restore: {
        ...
        enterSecretKeyInstructions: '输入您的密钥以恢复账户访问。',
    ...
    welcome: {
        ...
        createAccount: '注册账号',
        linkOrRestoreAccount: '登录',
        loginWithMobileApp: '登录',
        createAccountFailedInvalidResponse: '创建账户失败：服务器没有返回有效登录信息。请先确认右上角服务器地址已改成 https://api.hellovibe.com，然后再重试。',
        createAccountFailedWithReason: ({ reason }: { reason: string }) =>
            `创建账户失败：${reason}。请先确认右上角服务器地址已改成 https://api.hellovibe.com，然后再重试。`,
    },
    ...
    machine: {
        ...
        offlineHelp: '• 确保您的计算机在线\n• 运行 `happy daemon status` 进行诊断\n• 如有需要，请使用 `npm install -g happy-coder@latest` 更新 CLI',
        daemon: '守护进程',
        status: '状态',
        ...
        stopDaemonConfirmMessage: '停止后，在您重新在电脑上启动守护进程之前，将无法在这台设备上启动新会话。当前会话会继续保留。',
        daemonStopped: '守护进程已停止',
        stopDaemonFailed: '停止守护进程失败，可能它当前并未运行。',
        ...
        machineNotFound: '未找到设备',
        unknownMachine: '未知设备',
        multipleMachines: ({ count }: { count: number }) => `${count} 台设备`,
        renameMachineTitle: '重命名设备',
        renameMachineMessage: '为这台设备设置一个自定义名称。留空则继续使用默认主机名。',
        renameMachinePlaceholder: '输入设备名称',
        renameMachineSuccess: '设备名称修改成功',
        renameMachineFailed: '修改设备名称失败',
        createDirectoryTitle: '创建目录？',
        createDirectoryMessage: ({ directory }: { directory: string }) =>
            `目录“${directory}”不存在。要现在创建它吗？`,
        startSessionFailed: '启动会话失败。请确认目标设备上的守护进程已经运行。',
        unknownPath: '未知路径',
