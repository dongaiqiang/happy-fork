...
/**
 * Spanish translations for the HelloVibe app
...
export const es: TranslationStructure = {
    ...
    connect: {
        restoreAccount: 'Usar clave de respaldo',
        enterSecretKey: 'Ingresa tu clave de respaldo',
        invalidSecretKey: 'Clave de respaldo inválida. Verifica e intenta de nuevo.',
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'HelloVibe te ayuda a empezar tu primer vibe coding con más facilidad. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    newSession: {
        ...
        noMachinesFound: 'No se encontraron máquinas. Inicia una sesión de HelloVibe en tu computadora primero.',
        ...
        failedToStart: 'No se pudo iniciar la sesión. Asegúrate de que el servicio en segundo plano esté en ejecución en la computadora de destino.',
        sessionTimeout: 'Se agotó el tiempo al iniciar la sesión. La computadora puede estar lenta o el servicio en segundo plano puede no estar respondiendo.',
        ...
        noMachineSelected: 'Por favor, selecciona una computadora para iniciar la sesión',
        noPathSelected: 'Por favor, selecciona un directorio para iniciar la sesión',
        emptySessionsTitle: 'No active sessions',
        emptySessionsDescriptionWithMachines: 'Inicia una nueva sesión en cualquiera de tus computadoras conectadas.',
        ...
        machinePicker: {
            ...
            searchPlaceholder: 'Escribe para filtrar computadoras...',
            recentSectionTitle: 'Computadoras recientes',
            favoritesSectionTitle: 'Computadoras favoritas',
            allSectionTitle: 'Todas las computadoras',
            noItemsMessage: 'No hay computadoras disponibles',
            removeFavoriteTitle: 'Quitar de favoritos',
            removeFavoriteMessage: ({ machine }: { machine: string }) => `¿Quitar "${machine}" de tus computadoras favoritas?`,
        },
        pathPicker: {
            title: 'Select Path',
            noMachineSelected: 'No se ha seleccionado ninguna computadora',
        ...
        profileSection: {
            ...
            dismissThisMachine: 'esta computadora',
            dismissAnyMachine: 'cualquier computadora',
    ...
    server: {
        ...
        notValidHappyServer: 'No es un servicio HelloVibe válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de sesión de la app copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar el ID de sesión de la app',
        happySessionId: 'ID de sesión de la app',
        ...
        resumeNoAvailableMachine: ({ machineId }: { machineId: string }) =>
            `Ahora mismo no hay ninguna computadora en línea disponible para reanudar esta sesión. Esta sesión histórica está vinculada al ID de computadora ${machineId}, pero la aplicación no pudo encontrar su información de cifrado. Normalmente esto significa que el registro anterior de la computadora ya no es válido. Actualiza tu lista de computadoras o vuelve a iniciar sesión y prueba otra vez.`,
        ...
        resumeRpcUnavailable: 'El servicio en segundo plano está en ejecución, pero ahora mismo no está conectado al WebSocket del backend, así que el servicio no puede llegar a esta computadora por RPC. Reinicia el servicio de HelloVibe y el servicio en segundo plano y vuelve a intentarlo.',
        resumeMachineOffline: 'Esta computadora está sin conexión. Inicia el servicio en segundo plano en esta computadora y vuelve a intentarlo.',
        openOnMacTitle: 'Continuar en Mac',
        openOnMacConfirm: 'Continuar en Mac',
        openOnMacDescription: '¿Quieres continuar esta sesión en Mac? Después de abrirla, Mac pasará a ser el controlador predeterminado y el móvil quedará en solo lectura hasta que vuelvas a cambiarlo.',
        ...
        openOnMacOpeningSubtitle: 'Preparando la sesión en Mac...',
        openOnMacReadySubtitle: 'Continúa la misma sesión en Mac mientras el móvil mantiene el control',
        openOnMacSetupSubtitle: 'Intenta preparar un terminal de Claude alojado con tmux en tu Mac para esta sesión',
        ...
        openOnMacNoAvailableMachine: ({ machineId }: { machineId: string }) =>
            `Ahora mismo no hay ninguna computadora en línea disponible para continuar en Mac. Esta sesión histórica está vinculada al ID de computadora ${machineId}, pero la aplicación no pudo encontrar su información de cifrado. Normalmente esto significa que el registro anterior de la computadora ya no es válido. Actualiza tu lista de computadoras o vuelve a iniciar sesión y prueba otra vez.`,
        ...
        openOnMacAuthHint: 'Consejo: el servicio en segundo plano puede estar usando un inicio de sesión o perfil de Claude distinto del de tu terminal actual. Reinicia el servicio en segundo plano con el mismo contexto de inicio de sesión y vuelve a intentarlo.',
        openOnMacRouteMissing: ({ claudeSessionId, directory }: { claudeSessionId: string; directory: string }) =>
            `Falló continuar en Mac\nmotivo: El servicio actual todavía no ha desplegado el punto necesario para transferir la sesión a Mac. Vuelve a desplegar el servicio de HelloVibe y prueba otra vez.\nclaudeSessionId: ${claudeSessionId}\ndirectory: ${directory}`,
        ...
        happyHome: 'Directorio de datos de la app',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale HelloVibe CLI',
            runIt: 'Ejecútelo',
    ...
    settingsAccount: {
        ...
        backupDescription: 'Tu clave de respaldo es la única forma de recuperar tu cuenta. Guárdala en un lugar seguro, como un administrador de contraseñas.',
        secretKey: 'Clave de respaldo',
        tapToReveal: 'Toca para revelar',
        tapToHide: 'Toca para ocultar',
        secretKeyLabel: 'CLAVE DE RESPALDO (TOCA PARA COPIAR)',
        secretKeyCopied: 'Clave de respaldo copiada al portapapeles. ¡Guárdala en un lugar seguro!',
        secretKeyCopyFailed: 'No se pudo copiar la clave de respaldo',
        privacy: 'Privacidad',
        ...
        logoutConfirm: '¿Seguro que quieres cerrar sesión? ¡Asegúrate de haber guardado tu clave de respaldo!',
    },
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de HelloVibe. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
    ...
    navigation: {
        ...
        connectTerminal: 'Conectar terminal',
        linkNewDevice: 'Vincular nuevo dispositivo', 
        restoreWithSecretKey: 'Usar clave de respaldo',
        whatsNew: 'Novedades',
        friends: 'Amigos',
    },
    ...
    restore: {
        ...
        restoreWithSecretKeyInstead: 'Usar clave de respaldo',
        enterSecretKeyInstructions: 'Ingresa tu clave de respaldo para iniciar sesión en tu cuenta existente.',
    ...
    welcome: {
        ...
        title: 'HelloVibe',
        subtitle: 'Empieza tu primer vibe coding con facilidad.',
    ...
    machine: {
        ...
        stopDaemon: 'Detener servicio en segundo plano',
        stopDaemonConfirmTitle: '¿Detener el servicio en segundo plano?',
        stopDaemonConfirmMessage: 'No podrás abrir nuevas sesiones en esta computadora hasta que vuelvas a iniciar el servicio en segundo plano. Tus sesiones actuales seguirán activas.',
        daemonStopped: 'Servicio en segundo plano detenido',
        stopDaemonFailed: 'No se pudo detener el servicio en segundo plano. Puede que no esté en ejecución.',
        lastKnownPid: 'Último PID conocido',
        lastKnownHttpPort: 'Último puerto HTTP conocido',
        startedAt: 'Iniciado en',
        cliVersion: 'Versión del CLI',
        daemonStateVersion: 'Versión del estado del servicio en segundo plano',
        activeSessions: ({ count }: { count: number }) => `Sesiones activas (${count})`,
        machineGroup: 'Computadora',
        host: 'Host',
        machineId: 'ID de la computadora',
        username: 'Nombre de usuario',
        ...
        machineNotFound: 'No se encontró la computadora',
        unknownMachine: 'computadora desconocida',
        multipleMachines: ({ count }: { count: number }) => `${count} computadoras`,
        renameMachineTitle: 'Cambiar nombre de la computadora',
        renameMachineMessage: 'Asigna un nombre personalizado a esta computadora. Déjalo vacío para usar el nombre de host predeterminado.',
        renameMachinePlaceholder: 'Ingresa el nombre de la computadora',
        renameMachineSuccess: 'Se cambió el nombre de la computadora correctamente',
        renameMachineFailed: 'No se pudo cambiar el nombre de la computadora',
        createDirectoryTitle: 'Create Directory?',
        createDirectoryMessage: ({ directory }: { directory: string }) =>
            `The directory '${directory}' does not exist. Would you like to create it?`,
        startSessionFailed: 'No se pudo iniciar la sesión. Asegúrate de que el servicio en segundo plano esté en ejecución en la computadora de destino.',
