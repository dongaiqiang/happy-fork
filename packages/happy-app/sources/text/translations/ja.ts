/**
 * Japanese translations for the HelloVibe app
 * Values can be:
...
export const ja: TranslationStructure = {
    ...
    connect: {
        restoreAccount: 'バックアップキーを使う',
        enterSecretKey: 'バックアップキーを入力してください',
        invalidSecretKey: 'バックアップキーが無効です。確認して再試行してください。',
    ...
    settings: {
        ...
        about: 'このアプリについて',
        aboutFooter: 'HelloVibeは、最初のvibe codingをもっと気軽に始められるようにします。エンドツーエンド暗号化を採用し、アカウントはデバイスにのみ保存されます。Anthropicとは提携していません。',
        whatsNew: '新機能',
    ...
    newSession: {
        ...
        title: '新しいセッションを開始',
        noMachinesFound: 'マシンが見つかりません。まずコンピューターでHelloVibeセッションを起動してください。',
        ...
        failedToStart: 'セッションの開始に失敗しました。対象のコンピュータでバックグラウンドサービスが動作していることを確認してください。',
        sessionTimeout: 'セッションの開始がタイムアウトしました。コンピュータが遅いか、バックグラウンドサービスが応答していない可能性があります。',
        notConnectedToServer: 'サーバーに接続されていません。インターネット接続を確認してください。',
        noMachineSelected: 'セッションを開始するコンピュータを選択してください',
        noPathSelected: 'セッションを開始するディレクトリを選択してください',
        emptySessionsTitle: 'No active sessions',
        emptySessionsDescriptionWithMachines: '接続済みのコンピュータなら、どれでも新しいセッションを開始できます。',
        ...
        machinePicker: {
            title: 'コンピュータを選択',
            searchPlaceholder: '入力してコンピュータを絞り込み...',
            recentSectionTitle: '最近使ったコンピュータ',
            favoritesSectionTitle: 'お気に入りのコンピュータ',
            allSectionTitle: 'すべてのコンピュータ',
            noItemsMessage: '利用できるコンピュータがありません',
            removeFavoriteTitle: 'お気に入りから外す',
            removeFavoriteMessage: ({ machine }: { machine: string }) => `「${machine}」をお気に入りのコンピュータから外しますか？`,
        },
        pathPicker: {
            title: 'Select Path',
            noMachineSelected: 'コンピュータが選択されていません',
        ...
        profileSection: {
            ...
            dismissThisMachine: 'このコンピュータ',
            dismissAnyMachine: 'どのコンピュータでも',
    ...
    server: {
        ...
        notValidHappyServer: '有効なHelloVibeサービスではありません',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'アプリセッション ID がクリップボードにコピーされました',
        failedToCopySessionId: 'アプリセッション ID のコピーに失敗しました',
        happySessionId: 'アプリセッション ID',
        ...
        resumeNoAvailableMachine: ({ machineId }: { machineId: string }) =>
            `現在、このセッションを再開できるオンラインのコンピュータはありません。この履歴セッションはコンピュータ ID ${machineId} に紐づいていますが、アプリがその暗号化情報を見つけられませんでした。通常は古いコンピュータ記録が無効になっていることを意味します。コンピュータ一覧を更新するか、再度サインインしてお試しください。`,
        ...
        resumeRpcUnavailable: 'バックグラウンドサービスは動作中ですが、現在はバックエンド WebSocket に接続していないため、このコンピュータへ RPC で到達できません。HelloVibe サービスとバックグラウンドサービスを再起動して、もう一度お試しください。',
        resumeMachineOffline: 'このコンピュータはオフラインです。このコンピュータでバックグラウンドサービスを起動してから、もう一度お試しください。',
        openOnMacTitle: 'Mac で続ける',
        openOnMacConfirm: 'Mac で続ける',
        openOnMacDescription: 'このセッションを Mac で続けますか？開いた後は Mac が既定のコントローラになり、切り戻すまでモバイルは読み取り専用になります。',
        ...
        openOnMacOpeningSubtitle: 'Mac 用のセッションを準備しています...',
        openOnMacReadySubtitle: 'モバイルが現在の操作権を保ったまま、同じセッションを Mac で続けます',
        openOnMacSetupSubtitle: 'このセッションのために、Mac 上で tmux 管理の Claude ターミナルを準備します',
        ...
        openOnMacNoAvailableMachine: ({ machineId }: { machineId: string }) =>
            `現在、Mac で続きを開けるオンラインのコンピュータはありません。この履歴セッションはコンピュータ ID ${machineId} に紐づいていますが、アプリがその暗号化情報を見つけられませんでした。通常は古いコンピュータ記録が無効になっていることを意味します。コンピュータ一覧を更新するか、再度サインインしてお試しください。`,
        ...
        openOnMacAuthHint: 'ヒント: バックグラウンドサービスが使っている Claude のサインイン状態やプロファイルは、現在のターミナルと異なる場合があります。同じサインイン状態でバックグラウンドサービスを再起動して、もう一度お試しください。',
        openOnMacRouteMissing: ({ claudeSessionId, directory }: { claudeSessionId: string; directory: string }) =>
            `Mac で続けられませんでした\n理由: 現在のサービスには、Mac へ引き継ぐための必要なエンドポイントがまだデプロイされていません。HelloVibe サービスを再デプロイして、もう一度お試しください。\nclaudeSessionId: ${claudeSessionId}\ndirectory: ${directory}`,
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'HelloVibe CLIをインストール',
            runIt: '実行する',
    ...
    settingsAccount: {
        ...
        server: 'サーバー',
        backup: 'バックアップ',
        backupDescription: 'バックアップキーはアカウントを復元する唯一の方法です。パスワードマネージャーなどの安全な場所に保存してください。',
        secretKey: 'バックアップキー',
        tapToReveal: 'タップして表示',
        tapToHide: 'タップして非表示',
        secretKeyLabel: 'バックアップキー (タップでコピー)',
        secretKeyCopied: 'バックアップキーがクリップボードにコピーされました。安全な場所に保管してください！',
        secretKeyCopyFailed: 'バックアップキーのコピーに失敗しました',
        privacy: 'プライバシー',
        ...
        logoutConfirm: 'ログアウトしてもよろしいですか？バックアップキーを保存済みであることを確認してください！',
    },
    ...
    terminal: {
        ...
        terminalRequestDescription: 'ターミナルがHelloVibeアカウントへの接続を要求しています。これにより、ターミナルは安全にメッセージを送受信できるようになります。',
    ...
    navigation: {
        ...
        connectTerminal: 'ターミナルを接続',
        linkNewDevice: '新しいデバイスをリンク',
        restoreWithSecretKey: 'バックアップキーを使う',
        whatsNew: "新機能",
        friends: '友達',
    },
    ...
    restore: {
        ...
        restoreWithSecretKeyInstead: '代わりにバックアップキーを使う',
        enterSecretKeyInstructions: '既存のアカウントにサインインするため、バックアップキーを入力してください。',
    ...
    welcome: {
        ...
        title: 'HelloVibe',
        subtitle: '最初のvibe codingを気軽に始めよう。',
        createAccount: 'はじめる',
    ...
    machine: {
        ...
        stopDaemon: 'バックグラウンドサービスを停止',
        stopDaemonConfirmTitle: 'バックグラウンドサービスを停止しますか？',
        stopDaemonConfirmMessage: 'バックグラウンドサービスを再起動するまで、このコンピュータで新しいセッションを開始できなくなります。現在のセッションはそのまま維持されます。',
        daemonStopped: 'バックグラウンドサービスを停止しました',
        stopDaemonFailed: 'バックグラウンドサービスを停止できませんでした。現在は動作していない可能性があります。',
        lastKnownPid: '最後に確認されたPID',
        lastKnownHttpPort: '最後に確認されたHTTPポート',
        startedAt: '開始時刻',
        cliVersion: 'CLIバージョン',
        daemonStateVersion: 'バックグラウンドサービスの状態バージョン',
        ...
        machineNotFound: 'コンピュータが見つかりません',
        unknownMachine: '不明なコンピュータ',
        multipleMachines: ({ count }: { count: number }) => `${count} 台のコンピュータ`,
        renameMachineTitle: 'コンピュータ名を変更',
        renameMachineMessage: 'このコンピュータに任意の名前を付けます。空欄のままにすると、既定のホスト名を使用します。',
        renameMachinePlaceholder: 'コンピュータ名を入力',
        renameMachineSuccess: 'コンピュータ名を変更しました',
        renameMachineFailed: 'コンピュータ名を変更できませんでした',
        createDirectoryTitle: 'Create Directory?',
        createDirectoryMessage: ({ directory }: { directory: string }) =>
            `The directory '${directory}' does not exist. Would you like to create it?`,
        startSessionFailed: 'セッションを開始できませんでした。対象のコンピュータでバックグラウンドサービスが動作していることを確認してください。',
