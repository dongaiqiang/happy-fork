...
export const ja: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        stopSessionConfirm: 'このセッションを停止して再開可能な状態を保存しますか？',
        ...
        resumableStatus: '再開可能状態',
        resumableAvailable: '現在再開可能',
        resumableUnavailable: '現在再開不可',
        ...
        stopSessionSubtitle: 'セッションを停止して再開可能に保つ',
